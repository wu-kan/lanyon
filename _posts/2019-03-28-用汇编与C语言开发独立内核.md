...
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-0.jpg)

按下键盘任意按键后进入下一步。

#### 操作系统

![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-1.jpg)

第一次进入系统时并没有完全清除屏幕上的提示信息，原因是我不希望自己写的内核过多地控制屏幕显示内容；取而代之的是，用户可以手动输入`clear`指令用于清除屏幕上的内容。

#### 测试一些指令

![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-2.jpg)
...
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-3.jpg)
如图，这是运行`exec`指令后打开的第一个程序。做[上一个实验](https://wu-kan.cn/_posts/2019-03-18-加载用户程序的监控程序/)时并没有在运行时清空屏幕，因此可以看到我的姓名是直接叠加在输出界面上的。

![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-4.jpg)
...
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-5.jpg)

#### 退出

![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/2019/2019-03-28-6.jpg)
