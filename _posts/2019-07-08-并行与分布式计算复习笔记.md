...
![1561688227205](https://Mizuno-Ai.wu-kan.cn/assets/image/note/1561688227205.png)
...
![1561854072547](https://Mizuno-Ai.wu-kan.cn/assets/image/note/1561854072547.png)
...
3. **如何利用 MPI+OpenMP 实现高斯消元法**
   ...
   >
   >    ![1561808109540](https://Mizuno-Ai.wu-kan.cn/assets/image/note/pics/1561808109540.png)
   >
   > 5. 收敛性（Convergence）
   >
...
> 假设状态空间树中的平均分支因子（每个节点的子节点数（平均值））为 b，搜索一棵深度为 k 的树需要检索：![7](https://Mizuno-Ai.wu-kan.cn/assets/image/note/7.png)个结点。空间复杂度为 Θ(k)
...
![1561644969249](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561644969249.png)
...
![1561645738150](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561645738150.png)

如果简单地进行分派, 可能造成负责不均衡

![1561645773909](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561645773909.png)
...
![1561680402403](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561680402403.png)
...
![1561680741080](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561680741080.png)
...
![1561681923093](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561681923093.png)
...
![1561681996839](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561681996839.png)

#### 非阻塞型 send/recv

![1561682240146](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561682240146.png)
...
> ![1561682739048](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561682739048.png)

吞吐量(Throughput/Bandwidth): 操作执行时的速度

> ![1561682752366](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561682752366.png)

增加吞吐量的方法

1. 加快传输速度

   > ![1561682810347](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561682810347.png)

2. 加大带宽

   > ![1561682822715](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561682822715.png)
...
> ![1561683205266](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561683205266.png)
>
> ![1561683218826](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561683218826.png)
...
> ![1561684086835](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561684086835.png)
>
> ![1561684065267](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561684065267.png)
>
> ![1561684100528](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561684100528.png)
...
- 受通信粒度影响
  - Cache Size
    ![1561686179624](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686179624.png)
  - 任务划分
    ![1561686192011](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686192011.png)
  - 改变布局
    ![1561686242834](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686242834.png)
...
![1561685417531](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561685417531.png)
...
![1561685513851](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561685513851.png)

其中蓝色为在 Cache 中的部分, 所以我们需要 change grid traversal order

![1561685557966](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561685557966.png)

##### 融合循环

![1561685619379](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561685619379.png)
...
![1561686552619](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686552619.png)
...
![1561686580689](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686580689.png)

##### use finer-granularity locks

Alleviate contention for single global lock by using per-cell locks

![1561686602014](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行编程之性能优化/1561686602014.png)
...
![1561876200052](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876200052.png)

![1561876231140](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876231140.png)

![1561876237049](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876237049.png)

![1561876244416](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876244416.png)

![1561876251458](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876251458.png)

![1561876256252](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876256252.png)

![1561877309802](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561877309802.png)

并行化快速排序

![1561876444352](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876444352.png)
...
![1561876644011](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561876644011.png)
...
![1561877004670](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561877004670.png)

执行顺序为 0, 1, 2 ...

![1561877015674](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561877015674.png)
...
![1561877608737](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行之Cilk框架简介/1561877608737.png)
...
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/note/运算密度中文.png)
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/note/运算密度.png)
...
![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/note/复杂度.png)

### 3. 单源最短路径 Dijkstra 的并行版本及复杂度。

![图片描述](https://Mizuno-Ai.wu-kan.cn/assets/image/note/单源最短路径.png)
...
![1561874811015](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561874811015.png)
...
![1561875015024](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875015024.png)
...
- (source partitioned) execute each of the n shortest path problems on a different processor
  ![1561875310800](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875310800.png)
- (source parallel) use a parallel formulation of the shortest path problem to increase concurrency
  ![1561875337796](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875337796.png)

#### Floyd’s Algorithm

![1561875383130](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875383130.png)

![1561875392849](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875392849.png)

#### Floyd’s Algorithm (1-D Block Mapping)

![1561875458517](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875458517.png)

#### Floyd’s Algorithm (2-D Block Mapping)

![1561875477302](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875477302.png)

![1561875489573](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875489573.png)

![1561875524495](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875524495.png)

#### Floyd’s Algorithm: Communications

![1561875513775](https://Mizuno-Ai.wu-kan.cn/assets/image/note/assets.并行化的图算法/1561875513775.png)
